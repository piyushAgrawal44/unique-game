...
<body style="position: relative;">
      ...
      <section id="lsc_header" class="col-12">
        ...
        <div class="row lsc_match_meta_row mb-0">
          ...
          <div class="col-4 lsc_match_score_meta">
            <span class="lsc_match_score">0 - 0</span>
        ...
        <div class="text-center inputDiv mb-5" style="align-items: center; align-self: center;">
  ...
  <form action="./round2.php" id="next_round_form" method="post">
    <input type="number" name="round_no" value="1" hidden>
    <input type="number" hidden name="round_win_by" id="round_win_by">
    <button type="submit" class="btn btn-primary">Go to round 2</button>
  </form>
