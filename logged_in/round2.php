...
if (isset($_POST["round_win_by"]) && isset($_POST["round_no"])){
  ...
  if ($_POST["round_win_by"]==1) {
    $_SESSION["total_rounds_win_by_1"]=1;
  } else {
...
<?php require('./components/navbar.php'); ?>
  <h2 class="text-center text-light mb-5">Round 2</h2>
...
<div id="lsc_app" class="row">
  ...
  <section id="lsc_header" class="col-12">
    <div class="row lsc_series_meta_row">
      <div class="col-12">
        <span class="lsc_series_meta_detail">Round 2 of 3</span>
    ...
    <div class="row lsc_match_meta_row mb-0">
      ...
      <div class="col-4 lsc_match_score_meta">
        <span class="lsc_match_score"><?php echo $_SESSION["total_rounds_win_by_1"];?> - <?php echo 1-$_SESSION["total_rounds_win_by_1"];?></span>
...
<form action="./round3.php" id="next_round_form" method="post">
<input type="number" name="round_no" value="2" hidden>
<input type="number" hidden name="round_win_by" id="round_win_by">
<button type="submit" class="btn btn-primary">Go to round 3</button>
</form>
